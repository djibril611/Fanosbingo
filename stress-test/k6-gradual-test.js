...
export const options = {
  ...
  thresholds: {
    'card_selection_duration': ['p(95)<1000', 'p(99)<2000'],
    'lobby_load_duration': ['p(95)<500', 'p(99)<1000'],
    'card_selection_errors': ['rate<0.02'],
...
export function setup() {
  console.log('🚀 Starting gradual stress test: 400 users in 30 seconds');
...
export function teardown(data) {
  ...
  console.log(`\n✅ Gradual test completed in ${testDuration.toFixed(2)} seconds`);
